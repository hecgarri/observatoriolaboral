...
carpeta = "/home/hector/GoogleDriveUBB/OLR Ñuble - Observatorio laboral de Ñuble/Análisis Cualitativo/Minería de Texto/TRANSVERSAL/"
...
set.seed(1234)
wordcloud(names(freq), freq, min.freq = 2, scale=c(3,0.6), colors=brewer.pal(9, "Dark2"))
